export const localizationTsExample = 
...
export const localizationHtmlExample = `<quartz-cron [localization]="localization"></quartz-cron>`;

export const secondsTabLocalization = {
	tabs: {
		seconds: 'Секунди'
	},
	quartz: {
