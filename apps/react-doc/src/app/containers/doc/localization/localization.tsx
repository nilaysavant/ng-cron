	...
	render() {
		return (
			<div>
				...
				<p>
					All visible texts we keep in a separate file and use them by default.
				</p>

				<p>
					If you need to change some text field or select option use <code>localization</code> prop to pass your version.
					<br/>
					Your localization version will be deeply merged with default one that allows you to override only what you want.
				</p>
				...
				<div
					...
					<div className="card-body">
						...
						<ReCron localization={secondsTabLocalization}></ReCron>
					</div>
				</div>
