...
export class QuartzCronDay extends QuartzTabBaseComponent<CronTabBaseProps> {
	...
	private readonly daysOfWeekEvery = QuartzService.getList(Segment.dayOfWeek, true);
	private readonly daysOfWeek = QuartzService.getList(Segment.dayOfWeek);
	private readonly daysOfWeekCodes = QuartzService.getDaysOfWeekCodes();
	private readonly daysOfMonthEvery = QuartzService.getList(Segment.dayOfMonth, true);
	private readonly daysOfMonth = QuartzService.getList(Segment.dayOfMonth);
